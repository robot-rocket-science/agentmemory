"""StructMemEval benchmark adapter for agentmemory.

Ingests StructMemEval multi-session conversations into agentmemory,
...
def run_case(
    ...
    for query in case.queries:
        retrieved: str = query_agentmemory(store, query.question, budget=budget)
