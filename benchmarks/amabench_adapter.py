"""AMA-Bench adapter for agentmemory.

Ingests AMA-Bench (Zhao et al., ICLR 2026 Workshop) agentic trajectories
into agentmemory, runs retrieval for QA evaluation, and reports per-domain
...
def ingest_episode(store: MemoryStore, episode: Episode) -> int:
    """Ingest all trajectory steps of an episode into agentmemory.
