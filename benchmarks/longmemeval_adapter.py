"""LongMemEval benchmark adapter for agentmemory.

Ingests LongMemEval oracle sessions into agentmemory,
...
def ingest_sessions(
    ...
    for idx, session_turns in enumerate(question.haystack_sessions):
        ...
        # Create agentmemory session for isolation
...
def query_agentmemory(
    ...
    """Query agentmemory for a question. Returns (context, num_beliefs).
